...
/**
 * REST controller for managing {@link com.business.core.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    public List<Category> getAllCategories(@PathVariable String businessId) {
        log.debug("REST request to get all Categories");
        return categoryService.findAll(businessId);
    }
