...
/**
 * REST controller for managing {@link com.business.core.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    public ResponseEntity<List<Customer>> getAllCustomers(
        ...
        if ("invoice-is-null".equals(filter)) {
            log.debug("REST request to get all Customers where invoice is null");
            return new ResponseEntity<>(customerService.findAllWhereInvoiceIsNull(), HttpStatus.OK);
        }
        log.debug("REST request to get a page of Customers");
        Page<Customer> page = customerService.findAll(pageable, businessId);
