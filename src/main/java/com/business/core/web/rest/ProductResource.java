...
/**
 * REST controller for managing {@link com.business.core.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    public ResponseEntity<List<Product>> getAllProducts(
        ...
        if ("billingitem-is-null".equals(filter)) {
            log.debug("REST request to get all Products where billingItem is null");
            return new ResponseEntity<>(productService.findAllWhereBillingItemIsNull(), HttpStatus.OK);
        }
        log.debug("REST request to get a page of Products");
        Page<Product> page = productService.findAll(pageable, businessId);
