...
type DashboardFormGroupContent = {
  ...
  totalSaleTillDate: FormControl<IDashboard['totalSaleTillDate']>;
  totalProfitTillDate: FormControl<IDashboard['totalProfitTillDate']>;
};
...
export class DashboardFormService {
  createDashboardFormGroup(dashboard: DashboardFormGroupInput = { id: null }): DashboardFormGroup {
    ...
    return new FormGroup<DashboardFormGroupContent>({
      ...
      totalSaleTillDate: new FormControl(dashboardRawValue.totalSaleTillDate),
      totalProfitTillDate: new FormControl(dashboardRawValue.totalProfitTillDate),
    });
  }
